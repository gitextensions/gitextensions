...
public class DiffLineNumAnalyzerTests
{
    ...
    public void CanGetAddedMovedDiffInfo()
    {
        ...
        result.DiffLines[8].LineSegment.Length.Should().Be(10);
        ...
        result.DiffLines[11].LineSegment.Length.Should().Be(22);
        ...
        result.DiffLines[12].LineSegment.Length.Should().Be(31);
        ...
        result.DiffLines[13].LineSegment.Length.Should().Be(39);
        ...
        result.DiffLines[21].LineSegment.Length.Should().Be(22);
        ...
        result.DiffLines[22].LineSegment.Length.Should().Be(15);
        ...
        result.DiffLines[23].LineSegment.Length.Should().Be(23);
        ...
        result.DiffLines[24].LineSegment.Length.Should().Be(10);
        ...
        result.DiffLines[25].LineSegment.Length.Should().Be(12);
        ...
        result.DiffLines[26].LineSegment.Length.Should().Be(29);
        ...
        result.DiffLines[27].LineSegment.Length.Should().Be(31);
        ...
        result.DiffLines[28].LineSegment.Length.Should().Be(39);
