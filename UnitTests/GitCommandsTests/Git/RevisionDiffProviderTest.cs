...
namespace GitCommandsTests.Git
{
    ...
    public class RevisionDiffProviderTest
    {
        ...
        {
            (new RevisionDiffProvider()).Get(from, to).Should().BeEmpty();
        }
        ...
        {
            (new RevisionDiffProvider()).Get(from, to).Should().Be("-R");
        }
        ...
        {
            (new RevisionDiffProvider()).Get(from, GitRevision.UnstagedGuid).Should().Be("\"HEAD\"");
        }
