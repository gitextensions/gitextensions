...
namespace BugReporterTests
{
    ...
    public sealed class ErrorReportUrlBuilderTests
    {
        ...
        {
            var exception = new SerializableException(new Exception("OPPS!", new ApplicationException("BAM!", new DivideByZeroException("BOOM!"))));
...
DPI 288dpi (300% scaling)".Replace("\r\n", "\n");
            ...
            string url = _builder.Build(exception, exceptionInfo: null, environmentInfo, additionalInfo);
