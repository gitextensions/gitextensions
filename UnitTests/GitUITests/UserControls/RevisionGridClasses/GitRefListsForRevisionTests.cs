...
namespace GitUITests.UserControls.RevisionGridClasses
{
    [TestFixture]
    public class GitRefListsForRevisionTests
    {
        ...
        public void Setup()
        {
            ...
            _refs = new IGitRef[]
            {
                new GitRef(_module, "m", $"{GitRefName.RefsTagsPrefix}tag1"),
                new GitRef(_module, "m", $"{GitRefName.RefsHeadsPrefix}branch1"),
                new GitRef(_module, "m", $"{GitRefName.RefsRemotesPrefix}branch1"),
            };
            _revision = new GitRevision("bla")
            {
                Refs = _refs
            };
        }
        ...
        {
            ((Action)(() => new GitRefListsForRevision(new GitRevision("bla") { Refs = null }))).Should().Throw<ArgumentNullException>();
        }
