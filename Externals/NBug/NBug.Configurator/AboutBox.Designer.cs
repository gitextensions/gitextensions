namespace NBug.Configurator
{
	partial class AboutBox
	{
      ...
      this.copyrightLabel.Text = "Copyright © 2013 Teoman Soygul";
      // 
      // productNameLabel
      // 
      ...
      this.productHomePageLinkLabel.Size = new System.Drawing.Size(162, 13);
      this.productHomePageLinkLabel.TabIndex = 5;
      this.productHomePageLinkLabel.TabStop = true;
      this.productHomePageLinkLabel.Text = "https://github.com/soygul/NBug";
      // 
      // projectHomeLabel
      // 
