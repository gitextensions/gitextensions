...
IF NOT EXIST "%~p0\..\bin\Git-2.10.0-32-bit.exe" (
    "%~p0\tools\curl.exe" -L -k -o ..\bin\Git-2.10.0-32-bit.exe https://github.com/git-for-windows/git/releases/download/v2.10.0.windows.1/Git-2.10.0-32-bit.exe
