...
IF NOT EXIST "%~p0\..\bin\Git-1.9.4-preview20140929.exe" (
    "%~p0\tools\curl.exe" -L -k -o ..\bin\Git-1.9.4-preview20140929.exe https://github.com/msysgit/msysgit/releases/download/Git-1.9.4-preview20140929/Git-1.9.4-preview20140929.exe
