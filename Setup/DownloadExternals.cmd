...
IF NOT EXIST "%~p0\..\bin\Git-1.8.5.2-preview20131230.exe" (
    "%~p0\tools\curl.exe" -o ..\bin\Git-1.8.5.2-preview20131230.exe http://msysgit.googlecode.com/files/Git-1.8.5.2-preview20131230.exe
)
