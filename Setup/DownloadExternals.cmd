...
IF NOT EXIST "%~p0\..\bin\Git-2.12.2-64-bit.exe" (
    "%~p0\tools\curl.exe" -L -k -o ..\bin\Git-2.12.2-64-bit.exe https://github.com/git-for-windows/git/releases/download/v2.12.2.windows.1/Git-2.12.2-64-bit.exe
