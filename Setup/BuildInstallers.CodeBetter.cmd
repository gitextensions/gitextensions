...
%msbuild% %projectShellEx% /p:Platform=Win32 /p:PlatformToolset=v110 %msbuildparams%
IF ERRORLEVEL 1 EXIT /B 1
%msbuild% %projectShellEx% /p:Platform=x64 /p:PlatformToolset=v110 %msbuildparams%
IF ERRORLEVEL 1 EXIT /B 1
%msbuild% %projectSshAskPass% /p:Platform=Win32 /p:PlatformToolset=v110 %msbuildparams%
IF ERRORLEVEL 1 EXIT /B 1
