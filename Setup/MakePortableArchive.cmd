...
REM --## DO NOT MODIFY --
xcopy /y /i "..\GitUI\Translation\Czech.gif" GitExtensions\Translation\
IF ERRORLEVEL 1 EXIT /B 1
xcopy /y /i "..\GitUI\Translation\Czech.xlf" GitExtensions\Translation\
IF ERRORLEVEL 1 EXIT /B 1
xcopy /y /i "..\GitUI\Translation\Czech.Plugins.xlf" GitExtensions\Translation\
IF ERRORLEVEL 1 EXIT /B 1
...
IF ERRORLEVEL 1 EXIT /B 1
xcopy /y /i "..\GitUI\Translation\Latvian.gif" GitExtensions\Translation\
IF ERRORLEVEL 1 EXIT /B 1
xcopy /y /i "..\GitUI\Translation\Latvian.xlf" GitExtensions\Translation\
IF ERRORLEVEL 1 EXIT /B 1
xcopy /y /i "..\GitUI\Translation\Latvian.Plugins.xlf" GitExtensions\Translation\
IF ERRORLEVEL 1 EXIT /B 1
...
IF ERRORLEVEL 1 EXIT /B 1
xcopy /y /i "..\GitUI\Translation\Portuguese (Brazil).gif" GitExtensions\Translation\
IF ERRORLEVEL 1 EXIT /B 1
xcopy /y /i "..\GitUI\Translation\Portuguese (Brazil).xlf" GitExtensions\Translation\
IF ERRORLEVEL 1 EXIT /B 1
xcopy /y /i "..\GitUI\Translation\Portuguese (Brazil).Plugins.xlf" GitExtensions\Translation\
IF ERRORLEVEL 1 EXIT /B 1
...
IF ERRORLEVEL 1 EXIT /B 1
xcopy /y /i "..\GitUI\Translation\Spanish (Argentina).gif" GitExtensions\Translation\
IF ERRORLEVEL 1 EXIT /B 1
xcopy /y /i "..\GitUI\Translation\Spanish (Argentina).xlf" GitExtensions\Translation\
IF ERRORLEVEL 1 EXIT /B 1
xcopy /y /i "..\GitUI\Translation\Spanish (Argentina).Plugins.xlf" GitExtensions\Translation\
IF ERRORLEVEL 1 EXIT /B 1
