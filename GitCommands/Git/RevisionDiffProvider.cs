...
namespace GitCommands.Git
{
    ...
    public sealed class RevisionDiffProvider : IRevisionDiffProvider
    {
        ...
        private string GetInternal(string firstRevision, string secondRevision, string fileName = null, string oldFileName = null, bool isTracked = true)
        {
            ...
            Debug.Assert(
                !(firstRevision == secondRevision && (firstRevision.IsNullOrEmpty() || firstRevision == StagedOpt)),
                "Unexpectedly two identical artificial revisions to diff: " + firstRevision + ". This will be displayed as diff to HEAD, not an identical diff.");
