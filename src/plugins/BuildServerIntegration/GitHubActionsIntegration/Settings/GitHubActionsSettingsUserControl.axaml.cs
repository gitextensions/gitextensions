...
public partial class GitHubActionsSettingsUserControl : GitExtensionsControl, IBuildServerSettingsUserControl
{
    ...
    {
        InitializeComponent();
        lnkTokenManagement.Click += lnkTokenManagement_LinkClicked;
        InitializeComplete();
    }
    ...
    {
        string? apiUrl = (txtApiUrl.Text ?? string.Empty).Trim().TrimEnd('/').NullIfEmpty();
    ...
    private void lnkTokenManagement_LinkClicked(object? sender, EventArgs e)
    {
