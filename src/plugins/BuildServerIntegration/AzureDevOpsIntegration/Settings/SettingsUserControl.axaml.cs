...
public partial class SettingsUserControl : GitExtensionsControl, IBuildServerSettingsUserControl
{
    ...
    {
        InitializeComponent();
        TfsServer.PropertyChanged += TextBox_TextChanged;
        TfsBuildDefinitionNameFilter.PropertyChanged += TextBox_TextChanged;
        RestApiToken.PropertyChanged += TextBox_TextChanged;
        ExtractLink.Click += ExtractLink_LinkClicked;
    ...
    private void UpdateView()
    {
        ...
        try
        {
            ...
            labelRegexError.IsVisible = !BuildServerSettingsHelper.IsRegexValid(TfsBuildDefinitionNameFilter.Text);
    ...
    private void UpdateModel()
    {
        ...
        try
        {
            _currentSettings.ProjectUrl = TfsServer.Text ?? string.Empty;
            _currentSettings.BuildDefinitionFilter = TfsBuildDefinitionNameFilter.Text ?? string.Empty;
            _currentSettings.ApiToken = RestApiToken.Text ?? string.Empty;
        }
        finally
        {
            _isUpdating = false;
    ...
    private void TextBox_TextChanged(object? sender, AvaloniaPropertyChangedEventArgs e)
    {
    ...
    private void ExtractLink_LinkClicked(object? sender, EventArgs e)
    {
