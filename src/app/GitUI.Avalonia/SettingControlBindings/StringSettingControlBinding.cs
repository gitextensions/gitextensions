...
internal class StringSettingControlBinding : SettingControlBinding<StringSetting, TextBox>
{
    ...
    public override TextBox CreateControl()
    {
        ...
        return PluginSettingControlFactory.CreateTextBox(Setting.CustomControl);
    }

    public override void LoadSetting(SettingsSource settings, TextBox control)
    {
        if (string.IsNullOrEmpty(control.PlaceholderText) && PlaceholderText.Length > 0)
        {
        ...
        control.Text = control.AcceptsReturn
