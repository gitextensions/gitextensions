    ...
    where TNode : class, INode
{
    ...
    private readonly Lazy<Dictionary<MenuItemKey, Control>> _itemsIndex;
    ...
    public MenuItemsGenerator(IMenuItemFactory menuItemFactory)
    {
        ...
        _itemsIndex = new Lazy<Dictionary<MenuItemKey, Control>>(() => CreateItemsIndex());
    }

    private Dictionary<MenuItemKey, Control> CreateItemsIndex()
    {
        Dictionary<MenuItemKey, Control> itemsIndex = [];
    ...
    public bool TryGetMenuItem(MenuItemKey key, [NotNullWhen(true)] out Control? item)
    {
    ...
    private IEnumerable<ToolStripItemWithKey> CreateGitRefItems()
    {
        ...
        yield return _menuItemFactory.CreateMenuItem<MenuItem, TNode>(
        ...
        yield return new Separator().WithKey(MenuItemKey.GitRefActionsSeparator);
    }
    ...
    private IEnumerable<ToolStripItemWithKey> CreateRename()
    {
        ...
        {
            MenuItem item = _menuItemFactory.CreateMenuItem<MenuItem, TNode>(
...
{
    public static ToolStripItemWithKey WithKey(this Control item, MenuItemKey key)
    {
