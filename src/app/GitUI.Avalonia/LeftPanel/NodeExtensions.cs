...
internal static class NodeExtensions
{
    ...
    /// <summary>Filters <paramref name="nodes"/> for those that are not <see cref="Avalonia.Controls.TreeViewItem.IsExpanded"/>.
    ...
    /// <summary>Filters <paramref name="nodes"/> for those that are <see cref="Avalonia.Controls.TreeViewItem.IsExpanded"/>.
    /// This only makes sense on nodes <see cref="HavingChildren(IEnumerable{NodeBase})"/>,
    /// so you'll probably want to use that filter first.</summary>
