...
{
    private readonly TranslationString _donateText = new("We have a dedicated team of collaborators that spends a lot of time maintaining the app, working on new features and fixing bugs." +
    ...
    {
        InitializeComponent();
        pbxDonate.PointerPressed += PictureBox1Click;
        InitializeComplete();

        lblText.Text = _donateText.Text;
    }

    private void PictureBox1Click(object? sender, PointerPressedEventArgs e)
    {
