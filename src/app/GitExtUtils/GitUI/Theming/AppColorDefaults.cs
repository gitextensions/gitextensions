...
public static class AppColorDefaults
{
    ...
    private static readonly Dictionary<AppColor, Color> _values =
        new()
        {
            ...
            { AppColor.RevisionGridRelativeNonSelectedSubjectText, Color.Empty },
            { AppColor.RevisionGridRelativeSelectedBodyText, Color.Empty },
            { AppColor.RevisionGridNonRelativeNonSelectedSubjectText, Color.Empty },
            { AppColor.RevisionGridNonRelativeNonSelectedBodyText, Color.Empty },
            { AppColor.RevisionGridNonRelativeSelectedSubjectText, Color.Empty },
            { AppColor.RevisionGridNonRelativeSelectedBodyText, Color.Empty },
