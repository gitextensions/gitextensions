...
public static class AppColorDefaults
{
    ...
    private static readonly Dictionary<AppColor, Color> _values =
        new()
        {
            ...
            { AppColor.CommitInfoMessageBackground, Color.FromArgb(0xf5, 0xf5, 0xf5) },
            { AppColor.CommitInfoBorderBackground, Color.FromArgb(0xff, 0xff, 0xff) },
            { AppColor.CommitInfoHeaderBackground, Color.FromArgb(0xff, 0xff, 0xff) },
            { AppColor.CommitInfoRevisionBackground, Color.FromArgb(0xff, 0xff, 0xff) },
            { AppColor.FormResetCurrentBranchSoftBackground, Color.FromArgb(128, 255, 128) },
            { AppColor.FormResetCurrentBranchMixedBackground, Color.FromArgb(255, 255, 128) },
            { AppColor.FormResetCurrentBranchHardBackground, Color.FromArgb(255, 128, 128) },
            { AppColor.ChecklistSettingsPageSettingSetBackground, Color.FromArgb(128, 255, 128) },
            { AppColor.ChecklistSettingsPageSettingUnsetBackground, Color.FromArgb(255, 128, 128) },
            { AppColor.ChecklistSettingsPageSettingNotRecommendedBackground, Color.FromArgb(255, 255, 128) },
