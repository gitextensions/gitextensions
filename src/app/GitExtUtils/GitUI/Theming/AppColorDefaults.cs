    ...
    public static class AppColorDefaults
    {
        ...
        private static readonly Dictionary<AppColor, Color> Values =
            new()
            {
                ...
                { AppColor.AnsiTerminalGreenForeBold, Color.FromArgb(0x2f, 0xd6, 0x2f) },
                { AppColor.AnsiTerminalGreenBackBold, Color.FromArgb(0x87, 0xff, 0x87) },
                { AppColor.AnsiTerminalYellowForeNormal, Color.FromArgb(0xc6, 0xc6, 0x15) },
                { AppColor.AnsiTerminalYellowBackNormal, Color.FromArgb(0xf2, 0xf2, 0x93) },
                { AppColor.AnsiTerminalYellowForeBold, Color.FromArgb(0xe2, 0xe2, 0x04) },
                { AppColor.AnsiTerminalYellowBackBold, Color.FromArgb(0xd6, 0xd6, 0x00) },
