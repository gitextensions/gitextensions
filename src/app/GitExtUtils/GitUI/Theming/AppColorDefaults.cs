...
public static class AppColorDefaults
{
    ...
    private static readonly Dictionary<AppColor, Color> _values =
        new()
        {
            ...
            { AppColor.CommitInfoBackground, Color.FromArgb(0xff, 0xff, 0xff) },
            { AppColor.CommitInfoContentBackground, Color.FromArgb(0xf5, 0xf5, 0xf5) },
            { AppColor.RevisionGridAlternateRowBackground, Color.FromArgb(0xf9, 0xf9, 0xf9) },
            { AppColor.RevisionGridSelectionBackground, Color.FromArgb(0x00, 0x78, 0xd7) },
            { AppColor.RevisionGridRelativeNonSelectedSubjectText, Color.FromArgb(0xff, 0xff, 0xff) },
            { AppColor.RevisionGridRelativeSelectedBodyText, Color.FromArgb(0xbc, 0xbc, 0xbc) },
            { AppColor.RevisionGridNonRelativeNonSelectedSubjectText, Color.FromArgb(0x6d, 0x6d, 0x6d) },
            { AppColor.RevisionGridNonRelativeNonSelectedBodyText, Color.FromArgb(0x98, 0x98, 0x98) },
            { AppColor.RevisionGridNonRelativeSelectedSubjectText, Color.FromArgb(0xbc, 0xbc, 0xbc) },
            { AppColor.RevisionGridNonRelativeSelectedBodyText, Color.FromArgb(0xa1, 0xa1, 0xa1) },
            { AppColor.BrightGreen, Color.FromArgb(128, 255, 128) },
            { AppColor.BrightYellow, Color.FromArgb(255, 255, 128) },
            { AppColor.BrightRed, Color.FromArgb(255, 128, 128) },
