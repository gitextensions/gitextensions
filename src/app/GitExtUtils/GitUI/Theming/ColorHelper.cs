namespace GitExtUtils.GitUI.Theming
{
    public static class ColorHelper
    {
        ...
        /// Note that <see cref="SystemColors"/> and <see cref="AppColor"/> should not be adopted.
        /// </summary>
        ...
        /// <returns>The adopted color.</returns>
        ...
        {
            return new HslColor(SystemColors.Window).L < 0.5;
        }
        ...
        /// in the same way in the current theme as in the in´variant theme.
        /// </summary>
