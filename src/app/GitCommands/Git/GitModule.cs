...
namespace GitCommands
{
    ...
    public sealed partial class GitModule : IGitModule
    {
        ...
        private GitEncodingSettingsGetter GitEncodingSettingsGetter
        {
            get
            {
                if (_gitEncodingSettings is null)
                {
                    lock (_lock)
                    {
                        _gitEncodingSettings ??= new GitEncodingSettingsGetter(new EffectiveGitConfigSettings(GitExecutable));
                    }
                }
        ...
        private IGitConfigSettingsGetter LocalGitConfigSettings => _localGitConfigSettings ??= new GitConfigSettings(GitExecutable, GitSettingLevel.Local);
