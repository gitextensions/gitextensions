...
internal static class RevisionGridRefRenderer
{
    ...
    /// </summary>
    private static GraphicsPath CreateNotchLeftRoundRectPath(in Rectangle rect, int radius, int pointWidth)
    {
        int left = rect.X;
        int top = rect.Y;
    ...
    /// </summary>
    private static GraphicsPath CreateNotchRightRoundRectPath(in Rectangle rect, int radius, int pointWidth)
    {
        int left = rect.X;
        int top = rect.Y;
        int right = rect.Right;
    ...
    /// </summary>
    private static GraphicsPath CreatePointLeftRoundRectPath(in Rectangle rect, int radius, int pointWidth)
    {
        int left = rect.X;
        int top = rect.Y;
        int right = rect.Right;
    ...
    /// </summary>
    private static GraphicsPath CreatePointRightRoundRectPath(in Rectangle rect, int radius, int pointWidth)
    {
        int left = rect.X;
        int top = rect.Y;
        int right = rect.Right;
    ...
    private static GraphicsPath CreateRoundRectPath(in Rectangle rect, int radius)
    {
        int left = rect.X;
        int top = rect.Y;
    ...
    public static Rectangle DrawRef(bool isRowSelected, Font font, ref int offset, string name, in Color headColor, RefLabelIcon icon, in Rectangle bounds, Graphics graphics, bool dashedLine = false, bool fill = false, bool highlight = false, RefLabelShape shape = RefLabelShape.Rect)
    {
    ...
    private static void DrawRefBackground(bool isRowSelected, Graphics graphics, in Color color, in Rectangle bounds, GraphicsPath path, RefLabelIcon icon, bool dashedLine, bool fill, bool highlight, int iconXOffset)
    {
        SmoothingMode oldMode = graphics.SmoothingMode;
        graphics.SmoothingMode = SmoothingMode.AntiAlias;
