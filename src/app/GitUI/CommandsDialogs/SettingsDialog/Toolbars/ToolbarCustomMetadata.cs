...
[DataContract]
internal class ToolbarCustomMetadata
{
    // Display name of the custom toolbar (e.g., "Custom 01", "Custom 02"). Used as the lookup
    // key between the layout lists; not validated or restricted to a fixed set of values.
    [DataMember]
