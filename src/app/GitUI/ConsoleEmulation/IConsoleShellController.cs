...
/// <summary>Represents an interactive terminal session embedded in the repository browser's terminal tab.</summary>
public interface IConsoleShellController
{
    /// <summary>Gets the WinForms control to embed in the tab panel.</summary>
    Control Control { get; }

    /// <summary>Gets a value indicating whether the shell running inside the terminal is still active.</summary>
