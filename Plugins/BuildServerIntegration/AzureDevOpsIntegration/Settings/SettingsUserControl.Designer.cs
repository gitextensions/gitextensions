namespace AzureDevOpsIntegration.Settings
{
    partial class SettingsUserControl
    {
        ...
        private void InitializeComponent()
        {
            ...
            label13.Location = new Point(4, 31);
            ...
            labelBuildIdFilter.Location = new Point(217, 250);
            labelBuildIdFilter.Margin = new Padding(4, 0, 4, 0);
            labelBuildIdFilter.Name = "labelBuildIdFilter";
            labelBuildIdFilter.Size = new Size(1516, 25);
            ...
            RestApiTokenLabel.Location = new Point(4, 352);
            RestApiTokenLabel.Margin = new Padding(4, 0, 4, 0);
            RestApiTokenLabel.Name = "RestApiTokenLabel";
            RestApiTokenLabel.Size = new Size(128, 25);
            ...
            labelRegexError.Location = new Point(217, 283);
            labelRegexError.Margin = new Padding(4, 8, 4, 8);
            labelRegexError.Name = "labelRegexError";
            labelRegexError.Size = new Size(1516, 25);
            ...
            TfsServer.Location = new Point(217, 28);
            TfsServer.Margin = new Padding(4, 3, 4, 3);
            TfsServer.Name = "TfsServer";
            TfsServer.Size = new Size(1516, 31);
            ...
            TfsBuildDefinitionNameFilter.Location = new Point(217, 203);
            TfsBuildDefinitionNameFilter.Margin = new Padding(4, 3, 4, 3);
            TfsBuildDefinitionNameFilter.Name = "TfsBuildDefinitionNameFilter";
            TfsBuildDefinitionNameFilter.Size = new Size(1516, 31);
            ...
            tableLayoutPanel1.RowStyles.Add(new RowStyle());
            tableLayoutPanel1.RowStyles.Add(new RowStyle());
            tableLayoutPanel1.Size = new Size(1737, 483);
            ...
            label4.Location = new Point(217, 408);
            label4.Margin = new Padding(4, 0, 4, 0);
            label4.Name = "label4";
            label4.Size = new Size(1516, 75);
            label4.TabIndex = 14;
            ...
            ExtractLink.Location = new Point(217, 0);
            ExtractLink.Margin = new Padding(4, 0, 4, 0);
            ExtractLink.Name = "ExtractLink";
            ExtractLink.Size = new Size(1516, 25);
            ...
            RestApiToken.Location = new Point(217, 349);
            RestApiToken.Margin = new Padding(4, 3, 4, 3);
            RestApiToken.Name = "RestApiToken";
            RestApiToken.Size = new Size(1516, 31);
            ...
            TokenManagementLink.Location = new Point(217, 383);
            TokenManagementLink.Margin = new Padding(4, 0, 4, 0);
            TokenManagementLink.Name = "TokenManagementLink";
            TokenManagementLink.Size = new Size(1516, 25);
            ...
            label1.Location = new Point(217, 62);
            label1.Margin = new Padding(4, 0, 4, 8);
            label1.Name = "label1";
            label1.Size = new Size(1516, 100);
            label1.TabIndex = 13;
