...
namespace GitUI
{
    public static class GitUIExtensions
    {
        ...
        public static void OpenWithDifftool(this RevisionGridControl grid, string fileName, string oldFileName, GitUI.RevisionDiffKind diffKind, bool isTracked=true)
        {
