...
namespace GitUI.CommandsDialogs.BrowseDialog.DashboardControl
{
    public partial class UserRepositoriesList : GitExtensionsControl
    {
        ...
        protected override void OnVisibleChanged(EventArgs e)
        {
            ...
            // Reset the recent repo cache and the search
        ...
        private void TextBoxSearch_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Enter)
            {
                ...
                OpenRepository((Repository)items[0].Tag);
            }
        }
        ...
        /// </summary>
        /// <param name="selected">Repository</param>
        private void OpenRepository(Repository selected)
        {
