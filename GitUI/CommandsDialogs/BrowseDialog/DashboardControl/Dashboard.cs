...
namespace GitUI.CommandsDialogs.BrowseDialog.DashboardControl
{
    public partial class Dashboard : GitModuleControl
    {
        ...
        private void Dashboard_Load(object sender, EventArgs e)
        {
            ...
            showCurrentBranchMenuItem.Checked = GitCommands.Properties.Settings.Default.DashboardShowCurrentBranch;
        ...
        {
            bool newValue = !GitCommands.Properties.Settings.Default.DashboardShowCurrentBranch;
            GitCommands.Properties.Settings.Default.DashboardShowCurrentBranch = newValue;
