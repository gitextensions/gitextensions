...
namespace GitUI.CommandsDialogs.BrowseDialog.DashboardControl
{
    public partial class FormDashboardCategoryTitle : GitExtensionsForm
    {
        ...
        public FormDashboardCategoryTitle(IEnumerable<RepositoryCategory> existingCategories)
            : this()
        {
            if (existingCategories != null)
            {
                _existingCategories.AddRange(existingCategories.Select(c => c.Description));
            }
        }
