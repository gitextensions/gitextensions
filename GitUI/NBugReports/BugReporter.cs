...
namespace GitExtensions
{
    public static class BugReporter
    {
        ...
        internal static string Append(StringBuilder text, Exception exception)
        {
            ...
            {
                // Context: <context>
                AppendUnlessEmpty(userExternalOperationException.Context, TranslatedStrings.Context);
            }

            if (exception is ExternalOperationException externalOperationException)
            {
                // Operation: <operation> <object>
                AppendUnlessEmpty($"{externalOperationException.Operation} {externalOperationException.Object}", TranslatedStrings.Operation);

                // Arguments: <args>
                AppendUnlessEmpty(externalOperationException.Arguments, TranslatedStrings.Arguments);

                // Directory: <dir>
                AppendUnlessEmpty(externalOperationException.Directory, TranslatedStrings.Directory);
            }
