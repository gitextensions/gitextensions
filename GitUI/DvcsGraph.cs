...
namespace GitUI
{
    public sealed partial class DvcsGraph : DataGridView
    {
        ...
        private class Lanes : IEnumerable<Graph.ILaneRow>
        {
            ...
            private class ActiveLaneRow : Graph.ILaneRow
            {
                private Edges edges;
                private Node node;
            ...
            private class LaneEnumerator : IEnumerator<Graph.ILaneRow>
            {
            ...
            private class SavedLaneRow : Graph.ILaneRow
            {
