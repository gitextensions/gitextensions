    ...
    internal sealed class RevisionGraphColumnProvider : ColumnProvider
    {
            ...
            : base("Graph")
        {
            ...
            Column = new DataGridViewTextBoxColumn
            {
                ...
                MinimumWidth = GraphDrawer.GraphDrawer.LaneWidth
            };
        }
        ...
        public override void OnCellPainting(DataGridViewCellPaintingEventArgs e, GitRevision revision, int rowHeight, in CellStyle style)
        {
            ...
            bool PaintGraphCell(int rowIndex, Rectangle cellBounds, Graphics graphics)
            {
                ...
                _graphCache.Allocate(width, height, GraphDrawer.GraphDrawer.LaneWidth);
                ...
                void DrawItem(int index)
                    => GraphDrawer.GraphDrawer.DrawItem(_graphCache.GraphBitmapGraphics, index, width, rowHeight, _revisionGraph.GetSegmentsForRow, _revisionGraphDrawStyleCache, _revisionGraph.HeadId);
            }
        }
        ...
        private int CalculateGraphColumnWidth(in VisibleRowRange range, int currentWidth, int minimumWidth)
        {
            ...
            laneCount = Math.Min(laneCount, GraphDrawer.GraphDrawer.MaxLanes);
            int columnWidth = (GraphDrawer.GraphDrawer.LaneWidth * laneCount) + ColumnLeftMargin;
        ...
        {
            if (e.X >= ColumnLeftMargin && GraphDrawer.GraphDrawer.LaneWidth >= 0 && e.RowIndex >= 0)
            {
                int lane = (e.X - ColumnLeftMargin) / GraphDrawer.GraphDrawer.LaneWidth;
