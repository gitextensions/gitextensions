...
namespace GitUI
{
    ...
    public sealed partial class RevisionGridControl : GitModuleControl, IScriptHostControl, ICheckRefs, IRevisionGridFilter, IRevisionGridInfo, IRevisionGridUpdate
    {
...
#pragma warning restore CS1587 // XML comment is not placed on a valid language element
        ...
        bool IScriptHostControl.IsRevisionGrid => true;

        IWin32Window IScriptHostControl.Window => FindForm();

        IGitUICommands IScriptHostControl.UICommands => UICommands;
