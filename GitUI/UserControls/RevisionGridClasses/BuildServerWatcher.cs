...
namespace GitUI.RevisionGridClasses
{
    public class BuildServerWatcher : IDisposable
    {
        ...
        public void RevisionsCellPainting(DataGridViewCellPaintingEventArgs e, GitRevision revision, Brush foreBrush, Font rowFont)
        {
        ...
        public void RevisionsCellFormatting(DataGridViewCellFormattingEventArgs e, GitRevision revision)
        {
            switch (e.ColumnIndex)
            {
                case 4:
