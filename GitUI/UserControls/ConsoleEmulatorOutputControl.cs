...
namespace GitUI.UserControls
{
	...
	public class ConsoleEmulatorOutputControl : ConsoleOutputControl
	{
        ...
        public override void Reset()
        {
            ...
            _panel.Controls.Add(_terminal = new ConEmuControl() { IsStatusbarVisible = false, Dock = DockStyle.Fill, AutoStartInfo = null /* don't spawn terminal until we have gotten the command */});
        }
